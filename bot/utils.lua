...
function Kick_by_reply(cb_extra, success, result)
	if type(result) == 'boolean' then
		print('Old message :(')
		return false
	end
...
function Kick_by_reply_admins(cb_extra, success, result)
	if type(result) == 'boolean' then
		print('Old message :(')
		return false
	end
...
function ban_by_reply(cb_extra, success, result)
	if type(result) == 'boolean' then
		print('Old message :(')
		return false
	end
...
-- Ban by reply for admins
function ban_by_reply_admins(cb_extra, success, result)
	if type(result) == 'boolean' then
		print('Old message :(')
		return false
	end
...
-- Unban by reply
function unban_by_reply(cb_extra, success, result)
	if type(result) == 'boolean' then
		print('Old message :(')
		return false
	end
...
function banall_by_reply(cb_extra, success, result)
	if type(result) == 'boolean' then
		print('Old message :(')
		return false
	end
