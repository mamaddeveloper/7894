...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to SupeR HmD Pv!\n\nFor more information, check out our channels:\n\n https://telegram.me/HmdAntispmmaerchannel \n\nThanks for using @MeGa_HmD!"
     	return text
    end
    ...
    if matches[1] == 'groupssuper' and is_admin1(msg)then
		return chat_list(msg)
	elseif matches[1] == 'groupssuper' and to == 'user' then
		savelog(msg.to.id, name_log.." ["..msg.from.id.."] Used /chats")
		return chat_list(msg)
    end

	if matches[1] == 'chattolist' then
