...
return {
	...
	usagehtm = '<tr><td align="center">hash کد</td><td align="right">الگوریتم رشته های هش را بسیار هوشمند شناسایی و معرفی مینماید<br>هش ها پسورد های کد گذاری شده هستند</td></tr>',
